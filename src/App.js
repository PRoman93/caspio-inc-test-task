...
import './App.css';
import {LOGIN_PAGE, MY_PAGE, POSTS_PAGE, SINGLE_POST_PAGE} from "./accets/contstants";
...
import LoginPageContainer from "./ui/loginPage/loginPageContainer";
    ...
    return (
        <div className="App">
            <Switch>
                ...
                <Route path={LOGIN_PAGE} component={LoginPageContainer}/>
